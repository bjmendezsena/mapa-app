...
import 'package:map_app/models/reverse_query_response.dart';
...
class TrafficService {
  ...
  final _apiKey =
      'pk.eyJ1IjoiYmptZW5kZXpzZW5hIiwiYSI6ImNraDltaThxNzA2ejIycXRpc3pnc25teXEifQ.RSHS7mXlutgYBGaiVME_Jw';
  ...
  Future<SearchResponse> getResultadosPorQuery(
    ...
    try {
      ...
      return SearchResponse(type: '', features: [], attribution: '', query: []);
    }
  }
